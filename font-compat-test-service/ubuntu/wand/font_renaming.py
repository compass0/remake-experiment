    ...
    with wand_image(filename=img_path) as img:
        with Drawing() as ctx:
            ...
            try:
                ...
                print(originalfont[(originalfont.rfind("/")+1):])
...
print(font_rename_info_dic)
f = open("/data/louis/font-compat-test-service/modifying/data/font/font_rename_info.txt", 'w')
