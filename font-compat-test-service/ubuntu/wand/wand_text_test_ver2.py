...
def test_font_compat(font, letter,
                     img_path='/data/louis/font-compat-test-service/modifying/data/image/letter_display_for_test.png'):
...
def gen_font_image(font, message, letter_size = 32, img_path
                   ='/data/louis/font-compat-test-service/modifying/data/image/letter_display.png'):
    ...
    with Image(filename=img_path) as img:
        with Drawing() as ctx:
            ...
            if (np.where(font_img_numpy_grayscale == 0)[0]).size == 0:
                ...
                # print(font[(font.rfind("\\")+1):-4]+".png")
                # print("True1")
                font_img.save(filename="/data/louis/font-compat-test-service/modifying/web/result/"+ font[(font.rfind("/")+1):-4]+".png")
...
def main():
    ...
    font_file_path ="/data/louis/font-compat-test-service/modifying/data/font/"
