### multi-user version of wand_text_test_ver3 ###
...
#    =>   123RF_kkueez_L_TTF_11_ttf.png ```
    ...
    if success == False:
        ...
        imwrite(result_base_path + str(user_num) + "/" +
                font_copy[(font_copy.rfind("/")+1):-4] + "_" + success_bin_str + "_" + font_copy[-3:]+".png", font_img)
    ...
    # try:
        ...
        # imwrite(result_base_path + str(user_num) + "/" + font_name+".png", font_img)
    # except KeyError:
        # imwrite(result_base_path + str(user_num) + "/" +
                # font_copy[(font_copy.rfind("/")+1):-4]+".png", font_img)
...
def main():
    ...
    # with open("/data/louis/font-compat-test-service/modifying/data/font/font_rename_info.txt",'r') as inf:
