...
for input_size in range(100, 1600, 100):
    resized_img_h, size_h = image_resize(img, height = input_size)
    resized_img_w, size_w = image_resize(img, width = input_size)
