...
describe("불투명 PNG 로고 어셋 업로드", () => {
    ...
    it("PNG NonTransparent 로고 성공 테스트", ()=>{
        var project_name = "PNG NonTransparent 로고 성공 테스트"
    ...
    it("PNG NonTransparent 로고 실패 테스트", ()=>{
        var project_name = "PNG NonTransparent 로고 실패 테스트"
