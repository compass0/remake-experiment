...
describe("투명 JPG 로고 어셋 업로드", () => {
    beforeEach(() => {
        cy.login_post_first()
    })
    
    var to_be_success_imgs = ['200x133.jpg', '300x199.jpg', '400x266.jpg', '500x333.jpg', '700x466.jpg', '900x600.jpg', '1000x666.jpg']
    var to_be_fail_imgs = ['100x66.jpg']

    it("JPG Transparent 로고 성공 테스트", ()=>{
        var project_name = "JPG Transparent 로고 성공 테스트"
    ...
    it("JPG Transparent 로고 실패 테스트", ()=>{
        var project_name = "JPG Transparent 로고 실패 테스트"
